...
{
    public class ECommerceTable : TableBase
    {
        public override iSHOPParams BindTabs(out StringBuilder tbltext, out string xmlstring, string checksamplesizesp, string tabid, string _BenchMark, string[] _Comparisonlist, string timePeriod, string _ShopperSegment, string filterShortname, string _ShopperFrequency, string[] ShortNames, string StatPositive, string StatNegative, bool ExportToExcel, string TimePeriodShortName, string ulwidth, string ulliwidth, string Selected_StatTest, string IsStoreImagery, TableParams tableParams)
        {
            ...
            if (tableParams.Tab_Id_mapping)
            {
                ...
                paramvalues = new object[] { tableParams.TabIndexId, tableParams.Beverage_UniqueId, benchmark_UID.ToMyString(), comp_UID.ToMyString(), tableParams.TimePeriod_UniqueId.ToMyString(), tableParams.ShopperSegment_UniqueId.ToMyString(), tableParams.ShopperFrequency_UniqueId.ToMyString(), tableParams.Sigtype_UniqueId.ToMyString(), tableParams.Add_ShopperFrequency_UniqueId.ToMyString() };
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    ...
                    for (int tbl = 0; tbl < table_count; tbl++)
                    {
                        if (ds.Tables[tbl] != null && ds.Tables[tbl].Rows.Count > 0)
                        {
                            ...
                            tbltext.Append("<div class=\"rowitem\"><ul><li style=\"text-align:left;" + (LoyaltyPyramid ? "background-color: transparent" : "background-color: #D9E1EE") + ";color:#000000;\"><span> " + Get_ShortNames(ds.Tables[tbl].Rows[0][0].ToString()) + " </span></li>");
                            leftbody += "<div class=\"rowitem table-title\"><ul><li style=\"text-align:left;" + (LoyaltyPyramid ? "background-color: transparent" : "background-color: #D9E1EE") + ";color:#000000;\"><a class=\"table-title-bottom-line\"></a><div class=\"treeview minusIcon\"></div><span> " + Get_ShortNames(ds.Tables[tbl].Rows[0][0].ToString()) + " </span></li>";
                            righttbody += "<div class=\"rowitem table-title\"><ul style=\"\">";
                            for (int i = 0; i < complistaArray.Count(); i++)
                            {
                                if (i == 0)
                                {
                                    righttbody += "<li class=\"" + CleanClass(complistaArray[i] + "cell") + "\" style=\"text-align:left;" + (LoyaltyPyramid ? "background-color: transparent" : "background-color: #D9E1EE") + ";color:#000000;\"><span></span></li>";
                                }
                                else
                                {
                                    righttbody += "<li class=\"" + CleanClass(complistaArray[i] + "cell") + "\" style=\"text-align:left;" + (LoyaltyPyramid ? "background-color: transparent" : "background-color: #D9E1EE") + ";color:#000000;\"><span  style=\"\"></span></li>";
                                }
                                tbltext.Append("<li class=\"" + CleanClass(complistaArray[i] + "cell") + "\" style=\"text-align:left;" + (LoyaltyPyramid ? "background-color: transparent" : "background-color: #D9E1EE") + ";color:#000000;\"><span></span></li>");
                   ...
                   "</c>");
                            ...
                            for (int rows = 0; rows < rows_count; rows++)
                            {
                                ...
                                if (!Significance.Trim().ToLower().Contains("significance"))
                                {
                                    ...
                                    average = "";
                                    switch (Convert.ToString(ds.Tables[tbl].Rows[rows]["MetricItem"]).ToLower())
                                    {
                                        ...
                                        case "average expenditure":
                                        case "average pick up fee":
                                        case "average delivery fee":
                                        case "average number of items purchased":
                                        case "average shipping cost and service fees":
                                        case "average service fees for pick up":
                                        case "average service fees for delivery":
                                            {
                                                average = "Average";
                                                break;
                                            }
                                    ...
                                    {
                                        sampleSize = new Dictionary<string, string>();
                                        tbltext.Append("<li style=\"overflow: hidden;text-align: left; color: #878787;font-weight: bold;\">" + Get_ShortNames(Convert.ToString(ds.Tables[tbl].Rows[rows]["MetricItem"])) + "</span></li>");

                                        leftbody += "<li style=\"overflow: hidden;text-align: left; color: #878787;font-weight: bold;\"><span>" + Get_ShortNames(Convert.ToString(ds.Tables[tbl].Rows[rows]["MetricItem"])) + "</span></li>";

                                        string metricitem = Get_ShortNames(Convert.ToString(ds.Tables[tbl].Rows[rows]["MetricItem"]).Trim());
                                    ...
                                    {
                                        isitembold = false;
                                        if (IsItemBold(Convert.ToString(ds.Tables[tbl].Rows[rows]["MetricItem"])))
                                            leftbody += "<li class=\"itembold\" style=\"overflow: hidden;text-align: left;background-color: transparent;\"><span>" + Get_ShortNames(Convert.ToString(ds.Tables[tbl].Rows[rows]["MetricItem"])) + "</span></li>";
                                        else
                                            leftbody += "<li style=\"overflow: hidden;text-align: left;background-color: transparent;\"><span>" + Get_ShortNames(Convert.ToString(ds.Tables[tbl].Rows[rows]["MetricItem"]).Trim()) + "</span></li>";
                                      
                                        tbltext.Append("<li style=\"overflow: hidden;text-align: left;background-color: transparent;\"><span>" + Get_ShortNames(Convert.ToString(ds.Tables[tbl].Rows[rows]["MetricItem"])) + "</span></li>");
                                        ...
                                        if (isitembold && !itemboldcontent)
                                        {
                                            itemboldcontent = true;
                                        }
                                        metricitem = metricitem.Replace("<span style=\"font-size:15px;\">", "").Replace("</span>", "");
                                        if (!isitembold && itemboldcontent)
                                        {
                                            //metricitem =  metricitem.PadLeft(50);
                                        }
                                        xmlstring = cf.cleanExcelXML(metricitem);
                                       ...
                                       "</c> ");
                                        ...
                                        for (int i = 0; i < complistaArray.Count(); i++)
                                        {
                                            ...
                                            if (!string.IsNullOrEmpty(tblcolumns[i]))
                                            {
                                                if (tblcolumns.Contains(tblcolumns[i].ToLower()) && !isitembold)
                                                {
    ...
    "</c> ");
        ...
        public override iSHOPParams BindTabsWithin(out StringBuilder tbltext, out string xmlstring, string checksamplesizesp, string tabid, string _BenchMark, string[] _Comparisonlist, string timePeriod, string _ShopperSegment, string _SingleSelection, string _ShopperFrequency, string _filter, string filterShortname, string[] ShortNames, string StatPositive, string StatNegative, bool ExportToExcel, string TimePeriodShortName, string ulwidth, string ulliwidth, string Selected_StatTest, string IsStoreImagery, TableParams tableParams)
        {
            ...
            if (tableParams.Tab_Id_mapping)
            {
                ...
                paramvalues = new object[] { tableParams.TabIndexId, tableParams.Beverage_UniqueId, tableParams.ShopperSegment_UniqueId.ToMyString(), benchmark_UID.ToMyString(), comp_UID.ToMyString(), tableParams.TimePeriod_UniqueId.ToMyString(), tableParams.Filter_UniqueId, tableParams.ShopperFrequency_UniqueId.ToMyString(), tableParams.Sigtype_UniqueId.ToMyString(), tableParams.Add_ShopperFrequency_UniqueId.ToMyString() };
                ds_2 = dal.GetData_WithIdMapping(paramvalues, tabid);
                if (ds_2 != null && ds_2.Tables.Count > 0)
                {
                    ds = new DataSet();
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    ...
                    for (int tbl = 0; tbl < table_count; tbl++)
                    {
                        if (ds.Tables[tbl] != null && ds.Tables[tbl].Rows.Count > 0)
                        {
                            ...
                            tbltext.Append("<div class=\"rowitem table-title\"><ul><li style=\"text-align:left;" + (LoyaltyPyramid ? "background-color: transparent" : "background-color: #D9E1EE") + ";color:#000000;\"><a class=\"table-title-bottom-line\"></a><div class=\"treeview minusIcon\"></div><span> " + Get_ShortNames(ds.Tables[tbl].Rows[0][0].ToString()) + " </span></li>");
                            leftbody += "<div class=\"rowitem table-title\"><ul><li style=\"text-align:left;" + (LoyaltyPyramid ? "background-color: transparent" : "background-color: #D9E1EE") + ";color:#000000;\"><a class=\"table-title-bottom-line\"></a><div class=\"treeview minusIcon\"></div><span> " + Get_ShortNames(ds.Tables[tbl].Rows[0][0].ToString()) + " </span></li>";
                            righttbody += "<div class=\"rowitem table-title\"><ul style=\"\">";
                            for (int i = 0; i < complistaArray.Count(); i++)
                            {
                    ...
                    "</c>");
                            ...
                            for (int rows = 0; rows < rows_count; rows++)
                            {
                                ...
                                if (!Significance.Trim().ToLower().Contains("significance"))
                                {
                                    ...
                                    {
                                        sampleSize = new Dictionary<string, string>();
                                        tbltext.Append("<li style=\"overflow: hidden;text-align: center; color: #878787;font-weight: bold;\">" + Get_ShortNames(Convert.ToString(ds.Tables[tbl].Rows[rows]["MetricItem"])) + "</span></li>");

                                        leftbody += "<li style=\"overflow: hidden;text-align: center; color: #878787;font-weight: bold;\"><span>" + Get_ShortNames(Convert.ToString(ds.Tables[tbl].Rows[rows]["MetricItem"])) + "</span></li>";
    ...
    "</c> ");
        ...
        public override iSHOPParams BindTabsTimePeriod(out StringBuilder tbltext, out string xmlstring, string checksamplesizesp, string tabid, string _BenchMark, string[] _Comparisonlist, string _ShopperSegment, string _SingleSelection, string _ShopperFrequency, string _filter, string filterShortname, string[] ShortNames, string StatPositive, string StatNegative, bool ExportToExcel, string TimePeriodShortName, string ulwidth, string ulliwidth, string Selected_StatTest, string IsStoreImagery, TableParams tableParams)
        {
            ...
            if (tableParams.Tab_Id_mapping)
            {
                paramvalues = new object[] { tableParams.TabIndexId, tableParams.Beverage_UniqueId, tableParams.ShopperSegment_UniqueId.ToMyString(), tableParams.TimePeriodFrom_UniqueId.ToMyString(), tableParams.TimePeriodTo_UniqueId.ToMyString(), tableParams.Filter_UniqueId.ToMyString(), tableParams.ShopperFrequency_UniqueId.ToMyString(), tableParams.Sigtype_UniqueId.ToMyString(), tableParams.CustomBase_UniqueId.ToMyString(), tableParams.Add_ShopperFrequency_UniqueId.ToMyString() };
                ds_2 = dal.GetData_WithIdMapping(paramvalues, tabid);
                if (ds_2 != null && ds_2.Tables.Count > 0)
                {
                    ds = new DataSet();
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    ...
                    for (int tbl = 0; tbl < ds.Tables.Count; tbl++)
                    {
                        if (ds.Tables[tbl] != null && ds.Tables[tbl].Rows.Count > 0)
                        {
                            ...
                            tbltext.Append("<div class=\"rowitem table-title\"><ul><li style=\"text-align:left;" + (LoyaltyPyramid ? "background-color: transparent" : "background-color: #D9E1EE") + ";color:#000000;\"><span> " + Get_ShortNames(ds.Tables[tbl].Rows[0][0].ToString()) + " </span></li>");
                            leftbody += "<div class=\"rowitem table-title\"><ul><li style=\"text-align:left;" + (LoyaltyPyramid ? "background-color: transparent" : "background-color: #D9E1EE") + ";color:#000000;\"><a class=\"table-title-bottom-line\"></a><div class=\"treeview minusIcon\"></div><span> " + Get_ShortNames(ds.Tables[tbl].Rows[0][0].ToString()) + " </span></li>";
                            righttbody += "<div class=\"rowitem table-title\"><ul style=\"\">";
                            for (int j = 0; j < complistaArray.Count(); j++)
                            {
                                if (j == 0)
                                {
                                    righttbody += "<li class=\"" + CleanClass(complistaArray[j] + "cell") + "\" style=\"text-align:left;" + (LoyaltyPyramid ? "background-color: transparent" : "background-color: #D9E1EE") + ";color:#000000;\"><span></span></li>";
                                }
                                else
                                {
                                    righttbody += "<li class=\"" + CleanClass(complistaArray[j] + "cell") + "\" style=\"text-align:left;" + (LoyaltyPyramid ? "background-color: transparent" : "background-color: #D9E1EE") + ";color:#000000;\"><span  style=\"\"></span></li>";
                                }
                                tbltext.Append("<li class=\"" + CleanClass(complistaArray[j] + "cell") + "\" style=\"text-align:left;" + (LoyaltyPyramid ? "background-color: transparent" : "background-color: #D9E1EE") + ";color:#000000;\"><span></span></li>");
                                    ...
                                    else
                                    {
                                       ...
                                       "</c> ");
                                        ...
                                        for (int i = 0; i < complistaArray.Count(); i++)
                                        {
                                            ...
                                            if (!string.IsNullOrEmpty(complistaArray[i]))
                                            {
                                                if (tblcolumns.Contains(_commonfunctions.Get_TableMappingNames(complistaArray[i]).Trim().ToLower()) && !isitembold)
                                                {
    ...
    "</c> ");
        ...
        public override string CheckBlankValues(string rowvalue, string tablename, string metricItem)
        {
            ...
            else if (Convert.ToString(metricItem).Equals("AVERAGE NUMBER OF ITEMS PURCHASED", StringComparison.OrdinalIgnoreCase))
            {
            ...
            else if (Convert.ToString(metricItem).Equals("Approximate Average time in store", StringComparison.OrdinalIgnoreCase))
            {
               ...
               || Convert.ToString(metricItem).Equals("AVERAGE ONLINE ORDER SIZE", StringComparison.OrdinalIgnoreCase)
               || Convert.ToString(metricItem).Equals("AVERAGE SHIPPING COST AND SERVICE FEES", StringComparison.OrdinalIgnoreCase)
               || Convert.ToString(metricItem).Equals("AVERAGE SERVICE FEES FOR PICK UP", StringComparison.OrdinalIgnoreCase)
               || Convert.ToString(metricItem).Equals("AVERAGE SERVICE FEES FOR DELIVERY", StringComparison.OrdinalIgnoreCase))
            {
                if (string.IsNullOrEmpty(rowvalue))
                {
                    value = "";
   ...
   "</c>");
            ...
            //        else
            //        {
            //            xmlstring = "IS-TITLE MONTHLY PURCHASING AMOUNT: " + frequency;
            //        }
            //    }
            //}
            //else
            ...
            //edited by Nagaraju for e-com frequency
            //Date: 16-07-2017
            xmlstring = "IS-TITLE SHOPPING FREQUENCY: " + Get_ShortNamesFrequency(frequency);
     ...
     "</c>");
       ...
       "</c> ");
        ...
        #region bold items
        private bool IsItemBold(string item)
        {
            isitembold = false;
            if (TabIndexId == 2 || TabIndexId == 4)
            {
