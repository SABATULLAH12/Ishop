...
{
    public class BevaragesShopperReportGenerator : BaseBeverageReport, IBevaragesShopper
    {
        public void PrepareSlides()
        {
            try
            {
                ...
                InitializeAsposePresentationFile(HttpContext.Current.Server.MapPath(@"~\Templates\ReportGenerator\ReportGeneratorPPTFilesBeverage\Shopper.pptx"));
        ...
        public override void GenerateBeverageReport(string hdnyear, string hdnmonth, string hdndate, string hdnhours, string hdnminutes, string hdnseconds)
        {
            ...
            try
            {
                ...
                filename = "iSHOP_ReportGenerator_" + hdnyear + "" + Convert.ToString(hdnmonth).FormateDateTime() + "" + Convert.ToString(hdndate).FormateDateTime() + "_" + Convert.ToString(hdnhours).FormateDateTime() + "" + Convert.ToString(hdnminutes).FormateDateTime() + Convert.ToString(hdnseconds).FormateDateTime() + GlobalVariables.GetRandomNumber;
        ...
        public void Slide_2(ISlide slide, DataSet Ds)
        {
            ...
            //TextChanges 
            texboxvalue = "\n\n\nThis report compares " + Benchlist1 + " monthly+ purchasers to the monthly+ purchasers of " + complistNames + " across the key metrics in the iSHOP survey.\n\n" +
            ...
            texboxvalue = "Read as: " + shopperBenchValue.ToString("0%") + " of shoppers purchase " + Benchlist1 + " in a typical month";
            ...
            texboxvalue = "Read as: " + tripsBenchValue.ToString("0%") + " of " + Benchlist1 + " trips are made by monthly+ " + Benchlist1 + " purchasers";
        ...
        public void Slide_3(ISlide slide, DataSet Ds)
        {
            ...
            textboxvalue = "Read as: " + shopperBenchValue.ToString("0%") + " of monthly+ purchasers of " + Benchlist1 + " are male";
        ...
        public void Slide_4(ISlide slide, DataSet Ds)
        {
            ...
            textboxvalue = "Read as: " + shopperBenchValue.ToString("0%") + " of monthly+ purchasers of " + Benchlist1 + " are white";
            base.Create_Label(slide, textboxvalue, Color.FromArgb(242, 242, 242), Color.FromArgb(89, 89, 89), (float)391.68, (float)90.72, (float)372.24, (float)17.28, 9);
        ...
        public void Slide_5(ISlide slide, DataSet Ds)
        {
            ...
            textboxvalue = "Read as: " + shopperBenchValue.ToString("0%") + " of monthly+ purchasers of " + Benchlist1 + " are Pleasure Shoppers";
            base.Create_Label(slide, textboxvalue, Color.FromArgb(242, 242, 242), Color.FromArgb(89, 89, 89), (float)391.68, (float)90.72, (float)372.24, (float)17.28, 9);
        ...
        public void Slide_6(ISlide slide, DataSet Ds)
        {
            ...
            textboxvalue = "Read as: " + shopperBenchValue.ToString("0%") + " of monthly+ purchasers of " + Benchlist1 + " are also monthly+ shoppers of Grocery. This does not mean they purchased the product within this channel";
            base.Create_Label(slide, textboxvalue, Color.FromArgb(242, 242, 242), Color.FromArgb(89, 89, 89), (float)391.68, (float)90.72, (float)372.24, (float)17.28, 9);
        ...
        public void Slide_7(ISlide slide, DataSet Ds)
        {
            ...
            {
                textboxvalue = "Read as: " + Convert.ToDouble(tbltop.Rows[0]["Volume"]).ToString("0%") + " of monthly+ purchasers of " + Benchlist1 + " are also monthly+ shoppers of " + tbltop.Rows[0]["MetricItem"] + ". " +
                               "This does not mean they purchased the product within this retailer.";
            }

            base.Create_Label(slide, textboxvalue, Color.FromArgb(242, 242, 242), Color.FromArgb(89, 89, 89), (float)684.0, (float)462.96, (float)260.64, (float)28.08, 9);

            SourceStatSampleDynamicText(slide, reportparams, texboxvalue, samplesizeNames, Benchlist1);
            //

            List<string> _objectivelist = GetLegendList(ds.Tables[1]);
            Create_Shopper_Table(slide, _objectivelist, "Monthly+");
