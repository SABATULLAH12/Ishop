...
{
    public class SOAPPriorityRetailer : SOAPBase
    {
        public void GenerateReport(string hdnyear, string hdnmonth, string hdndate, string hdnhours, string hdnminutes, string hdnseconds)
        {
            try
            {
                ...
                InitializeAsposePresentationFile(HttpContext.Current.Server.MapPath(@"~\SOAP PPT Templates\PriorityRetailers\SOAP Template_Priority Retailer slides" + (objectivelist.Count) + ".pptx"));
        ...
        public void UpdateInputSelection(ISlide slide)
        {
            ...
            //ReplaceText(slide, "TextBox 20", "Source: Coca-Cola iSHOP Tracking Study " + reportparams.ShortTimePeriod + ", " + reportparams.ShopperFrequencyShortName + " " + reportparams.ShopperSegmentShortName + " Shoppers, " + reportparams.ShopperSegmentShortName + " Visits, Filters: " + Convert.ToString(reportparams.FilterShortNames).Replace("|", ", "));
            ReplaceText(slide, "TextBox 19", "[1] Stat Test vs Share of " + reportparams.ShopperFrequencyShortName + " " + reportparams.GeographyShortName+ "-" + reportparams.ShopperSegmentShortName+ " Shopper, [2] Stat Test vs Total Trips of " + reportparams.GeographyShortName+ "-" + reportparams.ShopperSegmentShortName+ ", [3] Stat Test vs Total " + reportparams.ShopperFrequencyShortName + " " + reportparams.GeographyShortName+ "-" + reportparams.ShopperSegmentShortName+ " Shopper");
