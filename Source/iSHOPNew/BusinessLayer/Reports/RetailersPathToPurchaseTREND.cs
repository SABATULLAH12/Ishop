...
{
    public class RetailersPathToPurchaseTREND : BaseReport
    {
       public RetailersPathToPurchaseTREND()
        { }
        public override void PrepareReport(ReportGeneratorParams param)
        {
            try
            {
                base.LoadSlides(HttpContext.Current.Server.MapPath(@"~\Templates\Reports\Report_Trend_Retailers_Path_To_Purchase.pptx"));               
                base.isTrend = true;
                base.benchmark = param.CustomBase_ShortName;

                string footerText = string.Empty;
                footerText += "Source: CCNA iSHOP Tracker- Time Period : " + param.ShortTimePeriod + " ; Retailer: " + param.ShopperSegment.Split('|')[1] + (param.ShopperFrequency.Equals("Total Visits", StringComparison.OrdinalIgnoreCase) || (string.IsNullOrEmpty(param.ShopperFrequency)) ? " - Total Trips" : " - " + param.ShopperFrequency ) + "; % Trips";
                        ...
                        case 4:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Density_Chart");
                        ...
                        case 8:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Daypart_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);

                                base.SampleSizeFooterTextForTrend(slide, chart_table, "TrendSampleSize");

                                chart_table = base.Get_Chart_Table(ds, 8, 2);
                                base.ReplaceTrendLineChart(slide, chart_table, "Day_of_the_Week_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header2", false);
                                break;
                            }
                        case 9:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Location_Prior_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);
                        ...
                        case 10:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Pre-Visit_Origin_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);
                        ...
                        case 11:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "TripMission_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);
                        ...
                        case 12:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Reason_For_Store_Choice_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);

                                base.SampleSizeFooterTextForTrend(slide, chart_table, "TrendSampleSize");

                                chart_table = base.Get_Chart_Table(ds, 12, 2);
                                base.ReplaceTrendLineChart(slide, chart_table, "Reason_For_Store_Choice_Top2Box_Chart");
                        ...
                        case 13:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Claimed_Visit_Motivation_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);
                        ...
                        case 14:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Another_Store_Considered");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);

                                base.SampleSizeFooterTextForTrend(slide, chart_table, "TrendSampleSize");

                                chart_table = base.Get_Chart_Table(ds, 14, 2);
                                base.ReplaceTrendLineChart(slide, chart_table, "Type_Of_Other_Stores_Considered_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header2", true);
                                break;
                            }
                        case 15:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Trip_Planing_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);
                        ...
                        case 16:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Device_Used_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);

                                base.SampleSizeFooterTextForTrend(slide, chart_table, "TrendSampleSize");

                                chart_table = base.Get_Chart_Table(ds, 16, 2);
                                base.ReplaceTrendLineChart(slide, chart_table, "Trip_Preparation_Type_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header2", false);
                                break;
                            }
                        case 17:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Most_Destination_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", true);

                                base.SampleSizeFooterTextForTrend(slide, chart_table, "TrendSampleSize");

                                chart_table = base.Get_Chart_Table(ds, 17, 2);
                                base.ReplaceTrendLineChart(slide, chart_table, "All_Destinatiton_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header2", true);
                                break;
                            }
                        case 19:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Item_Purchased_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", true);
                        ...
                        case 20:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Departments_Purchased_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", true);
                        ...
                        case 21:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Food_Categories_Purchased_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", true);
                        ...
                        case 22:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Bev_Ingredient_Categories_Purchased_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);
                        ...
                        case 23:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Bev_Categories_Purchased_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", true);
                        ...
                        case 24:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Brand_Categories_Purchased_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", true);
                        ...
                        case 25:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Device_Used_InStore_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);
                        ...
                        case 27:
                            {
                                ...
                                chart_table = base.Get_Chart_Table(ds, 27, 2);
                                base.ReplaceTrendLineChart(slide, chart_table, "Time_Spent_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);
                        ...
                        case 28:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Expenditure_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);
                        ...
                        case 29:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Numbeof_Items_Purchased_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);
                        ...
                        case 30:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Use_Self_CheckOut_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);

                                base.SampleSizeFooterTextForTrend(slide, chart_table, "TrendSampleSize");

                                chart_table = base.Get_Chart_Table(ds, 30, 2);
                                base.ReplaceTrendLineChart(slide, chart_table, "Payment_Method_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header2", false);
                                break;
                            }
                        case 31:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "UseOf_Coupons_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);

                                base.SampleSizeFooterTextForTrend(slide, chart_table, "TrendSampleSize");

                                chart_table = base.Get_Chart_Table(ds, 31, 2);
                                base.ReplaceTrendLineChart(slide, chart_table, "TypeOf_Coupon_Used_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header2", false);
                                break;
                            }
                        case 32:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Overall_Satisfaction");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);

                                base.SampleSizeFooterTextForTrend(slide, chart_table, "TrendSampleSize");

                                chart_table = base.Get_Chart_Table(ds, 32, 2);
                                base.ReplaceTrendLineChart(slide, chart_table, "Detailed_Satisfaction_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header2", false);
                                break;
                            }
                        case 33:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Location_After_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);
                        ...
                        case 34:
                            {
                                ...
                                base.ReplaceTrendLineChart(slide, chart_table, "Immediate_Consumption");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header1", false);

                                base.SampleSizeFooterTextForTrend(slide, chart_table, "TrendSampleSize");

                                chart_table = base.Get_Chart_Table(ds, 34, 2);
                                base.ReplaceTrendLineChart(slide, chart_table, "ImmediateConsumption_Top10_Chart");
                                base.ReplaceHeaderAndDescriptionText(slide, chart_table, "Header2", true);
                                break;
                            }
                    }
