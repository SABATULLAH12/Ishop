...
{
    public class CompareRetailersPathToPurchase: BaseReport
    {
        public CompareRetailersPathToPurchase()
        {
        ...
        public override void PrepareReport(ReportGeneratorParams param)
        {
            try
            {
                ...
                base.LoadSlides(HttpContext.Current.Server.MapPath(@"~\Templates\Reports\Report_Compare_Retailers_Path_To_Purchase.pptx"));

                string footerText = string.Empty;
                footerText += "Source: CCNA iSHOP Tracker- Time Period : " + param.ShortTimePeriod + " ; Base - " + (param.ShopperFrequency.Equals("Total Visits", StringComparison.OrdinalIgnoreCase) || (string.IsNullOrEmpty(param.ShopperFrequency)) ? "Total Trips" : param.ShopperFrequency) + "; % Trips";
                        ...
                        case 1:
                            {
                                ...
                                textBox += "Base - " + (param.ShopperFrequency.Equals("Total Visits", StringComparison.OrdinalIgnoreCase) || (string.IsNullOrEmpty(param.ShopperFrequency)) ? "Total Trips" : param.ShopperFrequency);
                        ...
                        case 27:
                            {
                                ...
                                chart_table = base.Get_Chart_Table(ds, 27, 1);
