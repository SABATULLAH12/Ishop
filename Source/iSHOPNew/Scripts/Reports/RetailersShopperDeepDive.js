...
function prepareContentArea() {
    ...
    if (ModuleBlock == "PIT") {
        ...
        reportparams.ModuleBlock = "WithinShopper";
        //reportparams.SPName = "usp_RetailerDeepdiveReports";
        reportparams.SPName = "usp_ReportWithinRetailerShopper";
        ...
        reportparams.SelectedReports = ["SUMMARY", "FREQUENTSHOPPER", "CROSSRETAILERSHOPPER", "SHOPPERPERCEPTION", "BEVERAGEINTERACTION", "APPENDIX"];
        reportparams.ModuleBlock = "TimeShopper";
        //reportparams.SPName = "usp_RetailerOverviewReportsForTrend";
        reportparams.SPName = "usp_ReportTrendRetailerShopper";
        if (IsProceedGenerateReport)
            reportparams.SampleSizeCheck = 1;
        else
            reportparams.SampleSizeCheck = 0;
