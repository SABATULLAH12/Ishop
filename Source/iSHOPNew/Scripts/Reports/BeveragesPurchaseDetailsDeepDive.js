...
function prepareContentArea() {
    ...
    if (ModuleBlock == "PIT") {
        ...
        reportparams.ModuleBlock = "WithinBeverageTrips";
        //reportparams.SPName = "usp_BeveragesTripReportWithin";
        reportparams.SPName = "usp_ReportBeverageDeepDivePitTrips";
        ...
        reportparams.ModuleBlock = "TimeBeverageTrips";
        //reportparams.SPName = "usp_BeveragesTripReportForTrend";
        reportparams.SPName = "usp_ReportBeverageDeepDiveTrendTrips";
        if (IsProceedGenerateReport)
            reportparams.SampleSizeCheck = 1;
        else
            reportparams.SampleSizeCheck = 0;
...
function DownloadReport() {
    ...
    if (ModuleBlock == "PIT")
        window.location.href = $("#URLReports").val() + "/Download?View=WithinBeverageTrips&year=" + year + "&month=" + month + "&date=" + date + "&hours=" + hours + "&minutes=" + minutes + "&seconds=" + seconds;
    else
        window.location.href = $("#URLReports").val() + "/Download?View=TimeBeverageTrips&year=" + year + "&month=" + month + "&date=" + date + "&hours=" + hours + "&minutes=" + minutes + "&seconds=" + seconds;
}