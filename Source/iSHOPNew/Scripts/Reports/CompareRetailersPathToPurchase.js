...
function prepareContentArea() {
    ...
    reportparams.ReportFlag = 3;
    reportparams.TabName = tabname;
    reportparams.ModuleBlock = "AcrossTrips";
    ...
    reportparams.SPName = "usp_ReportAcrossRetailerTrip";
...
function DownloadReport() {
    ...
    window.location.href = $("#URLReports").val() + "/Download?View=AcrossTrips&year=" + year + "&month=" + month + "&date=" + date + "&hours=" + hours + "&minutes=" + minutes + "&seconds=" + seconds;
}